...
### Section 3 — Train the custom CNN (Model A)

**Section 3.1 — Build model**
...
**Section 3.2 — Configure callbacks**
...
### Section 4 — Train MobileNetV2 (Model B)

**Section 4.1 — Build head**
...
**Section 4.2 — Stage 1 — train the head**
